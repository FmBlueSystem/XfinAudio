# Release Gate Integrity Specification

## Purpose

Define the integrity contract for the release and publication gates: they determine what would be
published from the Git index rather than the working tree, the coverage floor has exactly one owner,
the source distribution excludes planning and review scratch, and the publication path is gated as
