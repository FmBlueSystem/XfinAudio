...
| Binary redistribution | Pending legal review for GPLv3 obligations and third-party dependency redistribution obligations. |
...
- PySide6/Qt licensing and redistribution obligations remain pending legal review.
- `mutagen` licensing and redistribution obligations remain pending legal review.
...
Open-source source publication does not by itself clear packaged binaries, signed/notarized apps, DMGs, installers, or dependency bundles for redistribution. Release evidence must keep legal review pending until qualified review is completed.
